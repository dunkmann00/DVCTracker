...
def upgrade():
    ...
    op.add_column('stored_specials', sa.Column('type', specialtypes, nullable=True))
    ...
    op.execute(
        "UPDATE stored_specials SET type='PRECONFIRM'"
    )
...
def downgrade():
    ...
    op.add_column('stored_specials', sa.Column('type', sa.String(length=15), nullable=True))
